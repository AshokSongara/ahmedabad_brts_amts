...
class RouteRepositoryImpl implements RouteRepository {
  ...
  Future<FareResponse> getFareDetails(
    ...
    if (routeDetailsRequest.serviceType == "BRTS") {
      ...
      Response response = await apiClient.getDataWihHeader(
          "Fare/AMTS/${routeDetailsRequest.routeCode?.replaceAll("/", "%2F")}/startStop/${routeDetailsRequest.startCode}/endStop/${routeDetailsRequest.serviceType == "AMTS" ? routeDetailsRequest.originEnd :routeDetailsRequest.endCode}");
      fareResponse = FareResponse.fromJson(response.body);
      return fareResponse;
    }
  }
