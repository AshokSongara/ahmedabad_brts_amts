...
class SearchResultItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  serviceType == "AMTS" ?routeResult.routeDetails![0].fare != 0 ?Container(
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                              text: serviceType == "BRTS" ? "₹${getFare(routeResult.fare ?? 0)}" : "₹${getFare(routeResult.routeDetails![0].fare ?? 0)}",
                              style: satoshiRegularSmall.copyWith(
                                  fontWeight: FontWeight.w700,
                                  fontSize: 19.sp,
                                  color: AppColors.darkGray)),
