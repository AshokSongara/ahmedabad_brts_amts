...
class TicketPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final cutoutStartPos = maxHeight - maxHeight * 0.16;
    ...
    final leftCutoutStartY1 = cutoutStartPos/2.0;
    final rightCutoutStartY1 = cutoutStartPos/2.0 - _cutoutDiameter;
    final dottedLineY1 = cutoutStartPos/2.0 - _cutoutRadius;
    final leftCutoutStartY2 = cutoutStartPos/1.5;
    final rightCutoutStartY2 = cutoutStartPos/1.5 - _cutoutDiameter;
    final dottedLineY2 = cutoutStartPos/1.5 - _cutoutRadius;
    final leftCutoutStartY3 = cutoutStartPos - 65;
    final rightCutoutStartY3 = cutoutStartPos - 65 - _cutoutDiameter;
    final dottedLineY3 = cutoutStartPos - 65 - _cutoutRadius;
